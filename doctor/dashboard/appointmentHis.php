        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- page heading -->
                    <h1 class="h3 mb-2 text-gray-800">Doctor | Appointment History</h1>
                    

                    <!-- DataTables Test -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h3 class="m-0 font-weight-bold text-primary">Appointment History</h3>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php     
                                            ...
                                            // selecting Doctor
                                            $docSel = "SELECT * from doctors WHERE DocName='{$_SESSION['doc_name']}'";
                                            $docres = mysqli_query($mysqli, $docSel);
                                            $docRow = mysqli_fetch_assoc($docres);
                                            $docname = $docRow['DocName'];


                                            $sql = "SELECT * FROM appointments WHERE doc_id={$docRow['id']}";
                                        ...
                                        <?php while($myRow = mysqli_fetch_assoc($result)): ?>
                                            <?php
                                                ...
                                                // select users
                                                $selUser = "SELECT * FROM users WHERE id={$myRow['user_id']}";
                                                $run = mysqli_query($mysqli, $selUser);
                                                $useRow = mysqli_fetch_assoc($run);
                                                $user_id = $useRow['id'];
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $useRow['Fullname']; ?></td>
