                        ...
                        <div class="bed-formSection">
                            <div class="card myCard addRoom">
                                ...
                                <form action="" method="POST">
                                    ...
                                    <div class="form-group field">
                                        <label for="">Room Name as per the Ward</label>
                                        <input type="text" name="rooms" id="" class="form-control">
                                    </div>
